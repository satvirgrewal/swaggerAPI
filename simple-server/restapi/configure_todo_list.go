...
import (
	...
	"github.com/satvirgrewal/swaggerAPI/models"
	"github.com/satvirgrewal/swaggerAPI/restapi/operations"
	"github.com/satvirgrewal/swaggerAPI/restapi/operations/todos"
)

//go:generate swagger generate server --target ../../swaggerAPI --name TodoList --spec ../swagger.yml --principal interface{}
