...
import (
	...
	"github.com/satvirgrewal/oauth2-server/gen/models"
	"github.com/satvirgrewal/oauth2-server/gen/restapi/operations"
	"github.com/satvirgrewal/oauth2-server/gen/restapi/operations/customers"
)

//go:generate swagger generate server --target ../../gen --name OauthSample --spec ../../swagger/swagger.yml --principal models.Principal
...
func configureAPI(api *operations.OauthSampleAPI) http.Handler {
	...
	if api.GetAuthCallbackHandler == nil {
